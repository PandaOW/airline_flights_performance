...
# Clears the layout and does not display exception till callback gets executed
app.config.suppress_callback_exceptions = True

# Webscraping and Reading the airline data into pandas dataframe
...
app.layout = html.Div(children=[ 
                                ...
                                html.Div([
                                   ...
                                   # Add next division 
                                   html.Div([
                                       # Create aa division for adding dropdown helper text for choosing year
                                        html.Div(
                                            [
                                ...
                                # Add Computed graphs
                                # added an empty division and providing an id that will be updated during callback
                                html.Div([ ], id='plot1'),
                                ...
                                # Added a division with two empty divisions inside.
                               html.Div([
                                        html.Div([ ], id='plot4'),
                                        html.Div([ ], id='plot5')
                                ], style={'display': 'flex'}),
